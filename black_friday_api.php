...
if ($action !== 'update_bf_price' || empty($product_ref) || empty($product_label) || $prix_initial === null || $bf_price === null) {
...
try {
    ...
    $check_sql = "SELECT COUNT(*) as count FROM black_friday_prices WHERE product_ref = ?";
